...
<body>
    <section class="bg-myBlue py-10 min-h-screen flex items-center justify-center">
        <div class="container mx-auto w-1/3 bg-white p-10 text-center">
            ...
            <a href="{{ route('home') }}" class="bg-myBlue w-full py-4 px-5 text-white font-medium rounded-lg border-2 border-myBlue hover:bg-transparent hover:border-myBlack hover:text-myBlack duration-300">Kembali</a>
        </div>
    </section>
